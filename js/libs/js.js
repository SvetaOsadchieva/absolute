...
(function() {
    ...
    google.maps.Load = function(apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [["http://khm0.googleapis.com/kh?v=710\u0026hl=ru\u0026", "http://khm1.googleapis.com/kh?v=710\u0026hl=ru\u0026"], null, null, null, 1, "710", ["https://khms0.google.com/kh?v=710\u0026hl=ru\u0026", "https://khms1.google.com/kh?v=710\u0026hl=ru\u0026"]], null, null, null, null, [["http://cbk0.googleapis.com/cbk?", "http://cbk1.googleapis.com/cbk?"]], [["http://khm0.googleapis.com/kh?v=102\u0026hl=ru\u0026", "http://khm1.googleapis.com/kh?v=102\u0026hl=ru\u0026"], null, null, null, null, "102", ["https://khms0.google.com/kh?v=102\u0026hl=ru\u0026", "https://khms1.google.com/kh?v=102\u0026hl=ru\u0026"]], [["http://mt0.googleapis.com/mapslt?hl=ru\u0026", "http://mt1.googleapis.com/mapslt?hl=ru\u0026"]], null, null, null, [["https://mts0.googleapis.com/mapslt?hl=ru\u0026", "https://mts1.googleapis.com/mapslt?hl=ru\u0026"]]], ["ru", "US", null, 0, null, null, "http://maps.gstatic.com/mapfiles/", "http://csi.gstatic.com", "https://maps.googleapis.com", "http://maps.googleapis.com", null, "https://maps.google.com", "https://gg.google.com", "http://maps.gstatic.com/maps-api-v3/api/images/", "https://www.google.com/maps", 0, "https://www.google.com"], ["http://maps.google.com/maps-api-v3/api/js/27/7/intl/ru_ALL", "3.27.7"], [2230726045], 1, null, null, null, null, null, "", null, null, 0, "http://khm.googleapis.com/mz?v=710\u0026", null, "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "http://mt.googleapis.com/maps/vt/icon", [["http://maps.google.com/maps/vt"], ["https://maps.google.com/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 371000000, 371], 2, 500, [null, null, null, null, "http://www.google.com/maps/preview/log204", "", "http://static.panoramio.com.storage.googleapis.com/photos/", ["http://geo0.ggpht.com/cbk", "http://geo1.ggpht.com/cbk", "http://geo2.ggpht.com/cbk", "http://geo3.ggpht.com/cbk"], "https://maps.googleapis.com/maps/api/js/GeoPhotoService.GetMetadata", "https://maps.googleapis.com/maps/api/js/GeoPhotoService.SingleImageSearch", ["http://lh3.ggpht.com/", "http://lh4.ggpht.com/", "http://lh5.ggpht.com/", "http://lh6.ggpht.com/"]], ["https://www.google.com/maps/api/js/master?pb=!1m2!1u27!2s7!2sru!3sUS!4s27/7/intl/ru_ALL", "https://www.google.com/maps/api/js/widget?pb=!1m2!1u27!2s7!2sru"], null, 0, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, [null, null, null, null, null, null, null, null, null, [0, 0]], null, [], ["27.7"]], loadScriptTime);
    };
...
_.cb = function(a, b) {
    for (var c = _.bb(void 0, _.w(b)), d = _.bb(void 0, 0);
    d < c;
    ++d)a.push(b[d])
};
_.x = function(a) {
...
_.$d = function(a, b) {
    ...
    if (a) {
        ...
        this.f = new Xd(1, - 1), this.b = new Od(180, - 180)
};
...
_.He = function(a, b, c) {
    ...
    if (!b)
        return [];
    c = c || {};
    var l = _.Lb(_.nc), n = _.Lb(h), q = _.Lb(g), r = _.Lb(function(a) {
        a = n(a);
        if (!a.length)
...
Mg = function() {
    var a = _.N(new kf(_.R.data[4]), 0), b = new Ig(131071), c = (0, window.unescape)("%26%74%6F%6B%65%6E%3D");
    return function(d) {
        d = d.replace(Kg, "%27");
        var e = d + c;
        Lg || (Lg = /(?:https?:\/\/[^/]+)?(.*)/);
...
_.k.set = function(a, b) {
    ...
    var d = ib(c, a);
    if (d)
        if (a = d.ab, d = d.Bc, c = "set" + _.Cb(a), d[c])
            d[c](b);
        else 
            d.set(a, b);
    else 
...
_.A.prototype.unbind = function(a) {
    var b = Db(this), c = b[a];
    c && (c.zg && delete zb(c.Bc, c.ab)[_.yb(c.zg)], this[a] = this.get(a), b[a] = null)
};
...
Nd.prototype.set = function(a, b) {
    if (null != b&&!(b && _.x(b.maxZoom) && b.tileSize && b.tileSize.width && b.tileSize.height && b.getTile && b.getTile.apply))
        throw Error("\u041e\u0436\u0438\u0434\u0430\u0435\u043c\u043e\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435 \u0434\u043b\u044f \u0440\u0435\u0430\u043b\u0438\u0437\u0430\u0446\u0438\u0438: google.maps.MapType");
...
var di = _.Nc.google.maps, ei = fc.zb(), fi = (0, _.p)(ei.cb, ei);
di.__gjsload__ = fi;
_.Va(di.modules, fi);
delete di.modules;
...
_.k.internalAnchorPoint_changed = Me.prototype.internalPixelOffset_changed = function() {
    var a = this.get("internalAnchorPoint") || _.ch, b = this.get("internalPixelOffset") || _.dh;
...
_.k.changed = function() {
    var a = this.Zg(), b = this.mg(), c = Lf(this);
    if (a&&!a.b(this.G) || this.F != b || this.O != c)
        Mf(this.f), this.K(), this.F = b, this.O = c;
    this.G = a
};
_.k.X = function() {
    var a = "", b = this.Zg(), c = this.mg(), d = Lf(this), e = this.get("size");
    if (e) {
            ...
            if (f) {
                ...
                if (!Ni) {
                    ...
                    if (!ti) {
                        ...
                        var n = _.K(n, ui), q = new gf([]);
                        wi || (wi = {
                            b: - 1,
                            A: [, _.T, _.T]
                        });
                        var q = _.K(q, wi), r = new ff([]);
                        vi || (vi = {
                            b: - 1,
                            A: [, _.T]
                        });
